...
class HelperTestCase(TestCase): 
    ...
    def setUpTestData(cls):
        cls.search_params={'formatted_address': 'Grodzisk Mazowiecki, Polska', 'province': 'Mazowieckie', 'city': 'Grodzisk Mazowiecki', 'price_min': 300000, 'price_max': 400000, 'property_type': 'flat', 'offer_type': 'sell'}
        cls.search_params_2={'formatted_address': 'Muranów, Warszawa, Polska', 'province': 'Mazowieckie', 'city': 'Warszawa', 'district': 'Śródmieście', 'district_neighbourhood':'Muranów', 'price_min': 300000, 'price_max': 400000, 'property_type': 'flat', 'offer_type': 'sell'}  
        cls.search_params_3={'formatted_address': 'Mokotów, Warszawa, Polska', 'province': 'Mazowieckie', 'city': 'Warszawa', 'district': 'Mokotów', 'price_min': 300000, 'price_max': 400000, 'property_type': 'flat', 'offer_type': 'sell'}
        cls.search_params_4={'formatted_address': 'Mazowieckie, Polska', 'province': 'Mazowieckie', 'price_min': 300000, 'price_max': 400000, 'property_type': 'flat', 'offer_type': 'sell'}
        cls.search_params_5={'formatted_address': 'Elektoralna, Warszawa, Polska', 'province': 'Mazowieckie', 'city': 'Warszawa', 'district': 'Śródmieście','street':'Elektoralna', 'price_min': 300000, 'price_max': 400000, 'property_type': 'flat', 'offer_type': 'sell'}  
        cls.search_params_6={'price_min': 300000, 'price_max': 400000, 'property_type': 'flat', 'offer_type': 'sell'} 
        cls.search_params_7={'formatted_address': 'Grodzisk Mazowiecki, Polska', 'province': 'Mazowieckie', 'city': 'Grodzisk Mazowiecki', 'price_max': 4000, 'property_type': 'flat', 'offer_type': 'rent'}
#otodom
    def test_otodom_url_path(self):
        ...
        self.assertEqual(otodom.get_url_path(self.search_params_5),'pl/oferty/sprzedaz/mieszkanie/warszawa/srodmiescie')
    ...
    def test_otodom_request_params(self):
        self.assertEqual(otodom.url_query(self.search_params),{'distanceRadius': 0, 'market': 'ALL', 'viewType': 'listing', 'lang': 'pl', 'searchingCriteria': 'sprzedaz', 'priceMin': 300000, 'priceMax': 400000, 'limit': 24, 'page': 1})
...
#nieruchomosci_online
    ...
    def test_nieruchomosci_online_request_params(self):
        self.assertEqual(nieruchomosci_online.get_request_params(self.search_params),{',mieszkanie,sprzedaz,,Grodzisk Mazowiecki,,,,300000-400000,,,,,,,,,,,,,,,,,,,,,,': '','page': 1})
        self.assertEqual(nieruchomosci_online.get_request_params(self.search_params_2),{',mieszkanie,sprzedaz,,Warszawa,Muranów,,,300000-400000,,,,,,,,,,,,,,,,,,,,,,': '','page': 1})
        self.assertEqual(nieruchomosci_online.get_request_params(self.search_params_3),{',mieszkanie,sprzedaz,,Warszawa,Mokotów,,,300000-400000,,,,,,,,,,,,,,,,,,,,,,': '','page': 1})
        self.assertEqual(nieruchomosci_online.get_request_params(self.search_params_6),{',mieszkanie,sprzedaz,,,,,,300000-400000,,,,,,,,,,,,,,,,,,,,,,': '','page': 1})
...
#gratka
    def test_gratka_url_path(self):
        ...
        self.assertEqual(gratka.get_url_path(self.search_params_7),'/nieruchomosci/mieszkania/grodzisk-mazowiecki/wynajem')

    def test_gratka_request_params(self):
        self.assertEqual(gratka.get_url_query(self.search_params),{'cena-calkowita:min':300000,'cena-calkowita:max':400000,'page': 1})
...
#morizon
    ...
    def test_morizon_request_params(self):
        self.assertEqual(morizon.get_url_query(self.search_params),{'ps[price_from]':300000,'ps[price_to]':400000,'page': 1})
...
#domiporta
    def test_domiporta_url_path(self):
        self.assertEqual(domiporta.get_url_path(self.search_params),'/mieszkanie/sprzedam/mazowieckie/grodzisk-mazowiecki')
        self.assertEqual(domiporta.get_url_path(self.search_params_2),'/mieszkanie/sprzedam/mazowieckie/warszawa/muranow')
        self.assertEqual(domiporta.get_url_path(self.search_params_3),'/mieszkanie/sprzedam/mazowieckie/warszawa/mokotow')
        self.assertEqual(domiporta.get_url_path(self.search_params_4),'/mieszkanie/sprzedam/mazowieckie')
        self.assertEqual(domiporta.get_url_path(self.search_params_5),'/mieszkanie/sprzedam/mazowieckie/warszawa/elektoralna')
        self.assertEqual(domiporta.get_url_path(self.search_params_6),'/mieszkanie/sprzedam')
        self.assertEqual(domiporta.get_url_path(self.search_params_7),'/mieszkanie/wynajme/mazowieckie/grodzisk-mazowiecki')

    def test_domiporta_request_params(self):
        self.assertEqual(domiporta.get_url_query(self.search_params),{'Price.From':300000,'Price.To':400000,'PageNumber': 1})
